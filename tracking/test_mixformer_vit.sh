...
python tracking/test.py mixformer_vit_online baseline --dataset lasot --threads 8 --num_gpus 2 --params__model MixFormer-ViT-uphead-B-288-online.pth.tar --params__search_area_scale 5.05
